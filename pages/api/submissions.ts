...
export default async function handler(
  ...
  try {
    ...
    const formData = {
      ...
      eczemaHistory: (Array.isArray(fields.eczemaHistory) ? fields.eczemaHistory[0] : fields.eczemaHistory) === 'true',
      familyHistoryAsthma: (Array.isArray(fields.familyHistoryAsthma) ? fields.familyHistoryAsthma[0] : fields.familyHistoryAsthma) === 'true',
      ...
      insuranceId: Array.isArray(fields.insuranceId) ? fields.insuranceId[0] : fields.insuranceId || '',
    ...
    const submission: HealthSubmission = {
      ...
      eczemaHistory: formData.eczemaHistory,
      familyHistoryAsthma: formData.familyHistoryAsthma,
      sex: formData.sex,
